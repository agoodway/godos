...
The cli-interface capability defines the command structure and user-facing commands for the godos tool, including the new note-related commands introduced by the add-notes change.
