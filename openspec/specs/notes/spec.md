...
The notes capability allows users to create, manage, and store free-form markdown content (meeting notes, ideas, reference material, etc.) as individual `.md` files in a `notes/` subdirectory of the storage directory. This is separate from the todo list functionality.
